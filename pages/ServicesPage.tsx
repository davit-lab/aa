                    ...
                    <div className="rounded-[2.5rem] md:rounded-[3.5rem] overflow-hidden aspect-[4/3] shadow-xl group">
                      <img 
                        src={`https://framerusercontent.com/images/${
                          key === 'orthopedics' ? 'PCHp4YGU02Gr9bhVeNxl3NlwDeE.jpg' : 
                          key === 'pediatrics' ? '0JhnuSVKqzhBvoFbmldufpEA.jpg' : 
                          key === 'surgery' ? 'QQ50fOqBmC27PyxomM9BpnW9Yho.jpg' :
                          key === 'endodontics' ? 'Es82GeniQfvbrLe8GIg5ctOEq6M.jpg' :
                          key === 'aesthetics' ? 'NL9ZihxOkco4TeWtDDi8fz20.jpg' :
                          key === 'implantology' ? 'PCHp4YGU02Gr9bhVeNxl3NlwDeE.jpg' :
                          key === 'orthodontics' ? 'InTtVcj8vGawB5IxVzmu2I4ic.png' :
                          '0JhnuSVKqzhBvoFbmldufpEA.jpg'
                        }`} 
                        alt={service.title} 
